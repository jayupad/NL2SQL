...
def retrieve_and_chunk(db: Database, chunk_size: int, overlap_size: int) -> List[str]:
    """
    Method to retrieve, clean, and chunk SQL documentation data
    Args:
...
def populate_weaviate(transformed_data: List[str], force_refresh: bool) -> bool:
    """
...
def generate_with_search(query: str, limit: int, grouped_task: str) -> List[str]:
    """
